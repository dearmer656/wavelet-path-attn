#! /bin/bash
#SBATCH --job-name=PAT105_A2
#SBATCH --output=log_file/train/%j_pat105_a2_fixed64.txt
...
# PAT-105: A2 — fixed-interval k=64 cumulative mask (neighboring interval control).
# Deterministic trigger: (t+1)%64==0 → 8 positions per T=512.
# Same recipe as A0/A1. One-factor delta from A1: path_fixed_interval=64.
...
MASTER_PORT=$(( 20300 + SLURM_JOB_ID % 1000 ))
...
/cl/work5/hongyu-s/conda/envs/latest_transformers/bin/torchrun \
  ...
  --path_fixed_interval 64 \
  --preprocessing_num_workers 8 \
  --ddp_timeout 7200 \
  --seed 42 \
  --overwrite_output_dir \
  --output_dir runs/pat105_a2_fixed64_hotpotqa_5k_seed42 \
  --logging_dir ./pat105_a2_fixed64_hotpotqa_5k_seed42_log \
  --cfg_path runs/pat105_a2_fixed64_hotpotqa_5k_seed42/supply_model.cfg

echo "=== PAT-105 A2 fixed-64 done ==="
