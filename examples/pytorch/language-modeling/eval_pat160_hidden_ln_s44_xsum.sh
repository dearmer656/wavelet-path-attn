#!/bin/bash
#SBATCH --job-name=P160_hln_s44_xs
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/log_file/train/%j_pat160_hidden_ln_s44_xsum.txt
...
# PAT-160: XSum Filtered eval for QWAB-Hidden-LN s44
...
CKPT_DIR="runs/mix_medium_owt_hidden_ln_10ep_s44/checkpoint-15000"
...
RESULT_DIR="runs/mix_medium_owt_hidden_ln_10ep_s44/ckpt_eval_xsum_rouge"
...
echo "=== Done: PAT-160 Hidden-LN s44 XSum L512/L1024/L1536 ==="
