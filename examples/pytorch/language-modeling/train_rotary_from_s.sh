#! /bin/bash
#SBATCH --job-name=
#SBATCH --output=log_file/train/%j_rotary_from_s.txt
...
--eval_strategy steps --eval_steps 250 --logging_dir ./rotary_from_s_log --logging_steps 250 --save_steps 5000 --attn_implementation eager --path_use_qk_norm false \
--path_use_low_rank_w true --path_use_w_shortconv false --path_conv_size 3 --warmup_steps 5000 --path_conv_bias false --output_dir runs/rotary_from_s \
--gradient_accumulation_steps 2 --b_unfreeze_step 5000 --pe_method rotary --single_A_B False
