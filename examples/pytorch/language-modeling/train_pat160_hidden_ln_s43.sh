...
# instead of PaTH q_corr delta. One-factor change from Full QWAB (s43):
#   wavelet_ctx_feat_mode="hidden_ln" (was "q_minus_qcorr_meanh")
# All other flags, backbone, data, LR, epochs identical to Full QWAB s43.
...
echo '================= BEGIN RUN PAT-160 hidden_ln s43 ================='
...
/cl/work5/hongyu-s/conda/envs/latest_transformers/bin/torchrun \
  ...
  --output_dir runs/mix_medium_owt_hidden_ln_10ep_s43 \
  --logging_dir ./log_file/mix_medium_owt_hidden_ln_10ep_s43 \
  --cfg_path runs/mix_medium_owt_hidden_ln_10ep_s43/supply_model.cfg

echo "=== PAT-160 QWAB-Hidden-LN s43 done ==="
