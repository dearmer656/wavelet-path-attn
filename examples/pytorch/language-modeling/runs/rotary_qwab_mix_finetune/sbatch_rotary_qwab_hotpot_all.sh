#!/bin/bash
#SBATCH --job-name=rqwab_hp_all
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rotary_qwab_hotpot_all.txt
...
for SEED_INFO in "s42:42" "s43:43" "s44:44"; do
  SEED=${SEED_INFO%%:*}
  SEED_NUM=${SEED_INFO##*:}
