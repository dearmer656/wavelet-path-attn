#! /bin/bash
#SBATCH --job-name=
#SBATCH --output=log_file/train/%j_2r_w_freq_Bfreeze_path_attn_from_s.txt
...
--eval_strategy steps --eval_steps 250 --logging_dir ./2r_w_freq_Bfreeze_path_attn_from_s_log --logging_steps 250 --save_steps 5000 --attn_implementation path_attn_wfreq --path_use_qk_norm false \
