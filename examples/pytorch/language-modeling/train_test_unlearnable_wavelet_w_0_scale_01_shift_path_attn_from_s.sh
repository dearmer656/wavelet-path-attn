#! /bin/bash
#SBATCH --job-name=
#SBATCH --output=log_file/train/%j_test_unlearnable_wavelet_w_0_scale_01_shift_path_attn_from_s.txt
...
--eval_strategy steps --eval_steps 250 --logging_dir ./test_unlearnable_wavelet_w_0_scale_01_shift_path_attn_from_s_log --logging_steps 250 --save_steps 5000 --attn_implementation path_attn --path_use_qk_norm false \
--path_use_low_rank_w true --path_use_w_shortconv false --path_conv_size 3 --warmup_steps 5000 --path_conv_bias false --output_dir runs/test_unlearnable_wavelet_w_0_scale_01_shift_path_attn_from_s \
