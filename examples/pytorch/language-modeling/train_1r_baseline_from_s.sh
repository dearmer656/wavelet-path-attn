#! /bin/bash
#SBATCH --job-name=
#SBATCH --output=log_file/train/%j_1r_baseline_from_s.txt
...
--eval_strategy steps --eval_steps 250 --logging_dir ./1r_baseline_from_s_log --logging_steps 250 --save_steps 5000 --attn_implementation path_attn --path_use_qk_norm false \
