#!/bin/bash
#SBATCH --job-name=pat187_abl_qwab_L2048
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_pat187_abl_qwab_L2048_R16.txt
...
_slack() {
    python3 /project/nlp-work5/hongyu-s/gate1/scripts/notify_slack.py \
        ...
        --issue "PAT-187" \
        --gpu "1xGPU" \
        --summary "Stage 1 head ablation eval: QWAB L2048 R16, pilot (max_cases=20, n_random=5, K=4)"
}
trap '_slack $?' EXIT
...
echo "=== Done: PAT-187 QWAB L2048 R16 pilot ablation ==="
