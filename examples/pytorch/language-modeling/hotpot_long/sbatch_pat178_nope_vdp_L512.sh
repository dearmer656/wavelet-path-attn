#!/bin/bash
#SBATCH --job-name=pat178_nope_vdp_L512
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_pat178_nope_vdp_L512.txt
...
_slack() {
    python3 /project/nlp-work5/hongyu-s/gate1/scripts/notify_slack.py \
        ...
        --issue "PAT-178" \
        --gpu "a6000x1" \
        --summary "NoPE head-wise V/D/P dump L512 (64 cases, s42 ckpt15900)"
}
trap '_slack $?' EXIT
...
echo "=== Done: PAT-178 NoPE head-wise V/D/P L512 ==="
echo "Features: ${OUT_ROOT}/block_512/nope_s42_ckpt15900/"
