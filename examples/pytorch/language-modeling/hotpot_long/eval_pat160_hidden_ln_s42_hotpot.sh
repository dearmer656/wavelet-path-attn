#!/bin/bash
#SBATCH --job-name=P160_hln_hq
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_pat160_hidden_ln_s42_hotpot.txt
...
# PAT-160: HotpotQA-Long Uniform eval for QWAB-Hidden-LN s42
...
echo "=== Done: PAT-160 Hidden-LN s42 HotpotQA L512/L2048/L4096 ==="
