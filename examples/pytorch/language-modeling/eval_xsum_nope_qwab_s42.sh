#!/bin/bash
#SBATCH --job-name=xsum_nope_qwab
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/small_nope_qwab_10ep_s42/ckpt_eval_hm/%j_xsum_nope_qwab_s42.txt
...
# PAT-165: Filtered XSum eval for NoPE+QWAB small model, seed=42
...
XSUM_PORT=$(( 19500 + JOB_PORT_OFFSET ))
...
echo "=== NoPE+QWAB XSum eval | ckpt: ${BEST_CKPT} ==="
