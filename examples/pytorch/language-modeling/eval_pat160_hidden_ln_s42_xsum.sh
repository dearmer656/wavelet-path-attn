#!/bin/bash
#SBATCH --job-name=P160_hln_xs
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/log_file/train/%j_pat160_hidden_ln_s42_xsum.txt
...
# PAT-160: XSum Filtered eval for QWAB-Hidden-LN s42
...
CKPT_DIR="runs/mix_medium_owt_hidden_ln_10ep_s42/checkpoint-15000"
...
RESULT_DIR="runs/mix_medium_owt_hidden_ln_10ep_s42/ckpt_eval_xsum_rouge"
...
echo "=== Done: PAT-160 Hidden-LN s42 XSum L512/L1024/L1536 ==="
