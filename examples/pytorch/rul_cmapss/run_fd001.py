...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--sensor_stride", type=int, default=1,
                        help="Feature subsampling stride: 1=all features, 2=every other (k→k/2)")
...
def main() -> None:
    ...
    if args.smoke_test:
        from train_eval import smoke_test_all_models
        print("Running smoke test for all 6 models...")
        smoke_test_all_models(
            n_features=24,
